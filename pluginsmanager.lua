...
بابا, [۳۱.۰۱.۱۶ ۲۳:۳۶]
al function unlock_group_photo(msg, data)
if not is_momod(msg) then
return "For moderators only!"
end
local group_photo_lock = data[tostring(msg.to.id)]['settings']['lock_photo']
...
"!setabout : Set group description",
"!about : Read group description",
"!setrules : Set group rules",
"!rules : Read group rules",
"!setname : Set group name",
"!setphoto : Set group photo",
"!group name : Lock/unlock group name",
"!group photo : Lock/unlock group photo",
"!group member : Lock/unlock group member", 
