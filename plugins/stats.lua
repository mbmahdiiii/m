...
local function run(msg, matches)
  if matches[1]:lower() == 'mb' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "mb" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (mb)",-- Put everything you like :)
		"^[!/]([Mm]b)"-- Put everything you like :)
    }, 
  run = run
}
