...
usage = {
moderator = {
"!promote : Promote user as moderator",
"!demote : Demote user from moderator",
...
بابا, [۳۱.۰۱.۱۶ ۲۳:۴۶]
em : Remove group from moderation list",
},
sudo = {
"!adminprom : Promote user as admin (must be done from a group)",
"!admindem : Demote user from admin (must be done from a group)",
},
},
patterns = {
"^!(modadd)$",
